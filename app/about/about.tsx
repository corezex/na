...
const AboutPage = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Our Story Section */}
      {/* Quick AEO Answers — designed to match site aesthetic */}
      <section className="relative overflow-hidden bg-gradient-to-br from-emerald-50 via-teal-50 to-green-50 py-16 lg:py-20">
        ...
        <div className="relative max-w-5xl mx-auto px-6 sm:px-8">
          ...
          >
            <span className="inline-flex items-center px-4 py-2 rounded-full bg-white text-emerald-700 text-sm font-semibold shadow-sm mb-5 border border-emerald-100">
              <Zap className="w-4 h-4 mr-2" /> Quick Answers
            </span>
            <h2 className="text-3xl lg:text-4xl font-extrabold text-slate-900 tracking-tight">
              Frequently Asked <span className="text-emerald-600">Questions</span>
            </h2>
            <p className="mt-4 text-lg text-slate-600 max-w-2xl mx-auto">Concise, verifiable answers for search engines and clients.</p>
          </motion.div>

          <div className="grid gap-6 md:grid-cols-3">
            {[
              {
                title: "Who is Dietitian Tejal?",
                body: "MSc Dietetics, Certified Diabetic Educator, 12+ years clinical experience at LTMG (Sion) Hospital and Bhatia Hospital. Founder of DietFiniti with clinics in Mumbai (Lower Parel) and Thane (Kolshet Road).",
                icon: GraduationCap,
                color: "text-blue-600",
                bg: "bg-blue-50",
              ...
              },
              {
                ...
                body: "Personalised consultations for weight loss, medical weight management, pregnancy nutrition, weight gain, sports nutrition, bridal plans, and online support across India.",
                icon: Stethoscope,
              ...
              {
                title: "How is the plan personalised?",
                body: "Every plan is shaped around your routine, food preferences, health history, cooking access, and clinical context — never a generic meal chart.",
                icon: Target,
              ...
              <motion.article
                ...
                className={`rounded-3xl bg-white p-8 shadow-xl border ${item.border} hover:shadow-2xl transition-all duration-300 hover:-translate-y-1`}
              >
                <div className={`w-14 h-14 rounded-2xl ${item.bg} flex items-center justify-center mb-6 shadow-md`}>
