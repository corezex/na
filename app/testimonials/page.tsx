'use client';
export const metadata: Metadata = { description: "Client experiences and success stories from DietFiniti weight loss, pregnancy, sports and bridal nutrition programmes." };
...
export default function TestimonialsPage() {
  ...
  return (
    <title>Client Stories | DietFiniti</title>
<meta name="description" content="Client experiences and success stories from DietFiniti nutrition programmes." />
