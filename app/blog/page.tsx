...
const BlogImage = ({
  ...
  return (
    <meta name="description" content="Health and nutrition articles from DietFiniti covering Indian diets, weight management, pregnancy nutrition and lifestyle tips." />
